...
For the Banks project, I ended up with a graph containing around 6,400 people, 2,300 commodities, 2,600 places, and 7,100 documents. These aren't numbers that impress anyone working in data science. But for a single historical figure's correspondence network, they're rich enough to surface patterns that are genuinely hard to see through sequential reading.
